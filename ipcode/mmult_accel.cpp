...
void HLS_accel (AXI_VAL INPUT_STREAM[27*50 + 27*500 + 50*500 + NUM_PARA], AXI_VAL OUTPUT_STREAM[50*500])
{
...
//	#pragma HLS RESOURCE variable=return core=AXI4LiteS metadata="-bus_bundle CONTROL_BUS"
	...
	wrapped_mmult_hw <int, 27*50, 27*500, 50*500, 4, 5, 5>(INPUT_STREAM, OUTPUT_STREAM);
